...
public class XifradorAES implements Xifrador {
    ...
    public XifradorAES(String clau) {
        this.clau = clau;
    }

    public byte[] xifraAES(String missatge, String contrasenya) throws Exception {
    ...
    public String desxifraAES(byte[] bytesXifrats, String contrasenya) throws Exception {
    ...
    public static void main(String[] args) {
        String[] missatges = {"Lorem ipsum dicet", "Hola Andrés cómo está tu cuñado", "Àgora ïlla Ôtto"};
        String clau = "ElFCBGuanyaraElTriplet";
        XifradorAES xifrador = new XifradorAES(clau);

        for (String missatge : missatges) {
            byte[] bytesXifrats = null;
            String desxifrat = "";
            try {
                bytesXifrats = xifrador.xifraAES(missatge, clau);
                desxifrat = xifrador.desxifraAES(bytesXifrats, clau);
            } catch (Exception e) {
